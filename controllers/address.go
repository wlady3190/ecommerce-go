...
func AddAdrress() gin.HandlerFunc {
...
func EditWorkAdress() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		_, err = UserCollection.UpdateOne(ctx, filter, update)
		if err != nil {
			c.IndentedJSON(500, "somehitn went worg updating")
		}
		defer cancel()
		ctx.Done()
		c.IndentedJSON(200, "ok updaing work address")

	}

}

func DeleteAdrress() gin.HandlerFunc {
